...
import { Mail, Lock, AlertCircle, Eye, EyeOff, User, Building } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-8 bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-background-light/20 animate-fadeIn">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors ${
              formData.role === 'user'
                ...
                : 'bg-white/5 text-background-light/70 border border-background-light/20'
            }`}
          >
            <User size={16} />
            <span>User</span>
        ...
        <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              {formData.role === 'user' ? 'Create User Account' : 'Create Company Account'}
            </button>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-background-light/70">
              Already have an account?{' '}
              <NavLink to="/signin" className="font-medium text-secondary hover:text-secondary-dark transition">
                Login
              </NavLink>
            </p>
          </div>
