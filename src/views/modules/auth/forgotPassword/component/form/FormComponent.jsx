                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                ...
                                <input
                                    ...
                                    className={`block w-full pl-10 pr-3 py-2 border ${error ? 'border-error' : 'border-background-light/30'
                            ...
                            >
                                <span className="absolute right-3 inset-y-0 flex items-center">
                                    {isResend ? (
                                        <RefreshCw
                                            size={18}
                                            className={`text-secondary-light group-hover:text-secondary-lighter transition-transform duration-300 ${isSubmitting ? 'animate-spin' : 'group-hover:rotate-180'
                                                }`}
                                        />
                                    ) : (
                                        <ArrowRight
