                                ...
                                <div>
                                    ...
                                    <div className="mt-1 relative">
                                        ...
                                        <input
                                            ...
                                            className={`block w-full pl-10 pr-3 py-2 border ${errors.email ? 'border-error' : 'border-background-light/30'
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 relative">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className={`block w-full pl-10 pr-10 py-2 border ${errors.password ? 'border-error' : 'border-background-light/30'
                                                } placeholder-background-light/50 text-background-light bg-white/5 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-secondary sm:text-sm`}
                                            placeholder="••••••••"
                                        />
                                        <button
